...
- Name: 05-admin.spec.ts >> Admin Panel >> pending approvals section on dashboard
- Location: tests\05-admin.spec.ts:60:7
...
Expected: visible
Error: strict mode violation: locator('text=Pending Approvals') resolved to 2 elements:
    1) <h2 class="font-semibold text-gray-700 flex items-center gap-2">…</h2> aka getByRole('heading', { name: 'Pending Approvals' })
    2) <p class="text-center text-gray-400 text-sm py-6">No pending approvals 🎉</p> aka getByText('No pending approvals 🎉')
